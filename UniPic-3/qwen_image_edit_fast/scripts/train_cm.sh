...
#   CODE_DIR=/path/to/UniPic-3 bash qwen_image_edit_fast/scripts/train_cm.sh
...
torchrun \
    ...
    --work_dir ${WORK_DIR:-work_dirs/Qwen-Image-Edit-CM-full-20k-bsz256-all-datasets} \
    --guidance_scale ${GUIDANCE_SCALE:-1.75} \
    --train_steps ${TRAIN_STEPS:-20000} \
    --ckpt_steps ${CKPT_STEPS:-1000} \
    --accum_steps ${ACCUM_STEPS:-4} \
    --ema_rate ${EMA_RATE:-0.95} \
    --tangent_norm \
