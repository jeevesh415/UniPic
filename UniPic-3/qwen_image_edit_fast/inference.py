...
from pipeline_qwenimage_edit import calculate_shift, QwenImageEditPipeline
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_model", type=str, default="Qwen-Image-Edit",
                        help="Base model for VAE and text encoder")
    parser.add_argument("--lora_path", type=str, default="work_dirs/Qwen-Image-Edit-DMD-20k-bsz16-all-datasets/step1000/transformer_lora/pytorch_model.bin",
                        help="Base model for VAE and text encoder")
